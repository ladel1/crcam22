...
class CommandController extends AbstractController
{
     ...
     */
    public function new(Request $request, CommandRepository $commandRepository,LineRepository $lRepo, ProductRepository $pRepo): Response
    {
        $command = new Command();
        ...
        if ($form->isSubmitted() && $form->isValid()) {            
            $product_ids = (array) $request->request->get("command")["products"];
            ...
            foreach($product_ids as $id){
                ...
                $command->addCommandProduct($line); 
                $lRepo->add($line,true); 
            }            
